...
4. If the user instead chooses to search for courses, the  user can fill out the search form with search criteria and press submit, and then the current page is forwarded to a search results page in the form of a table.
